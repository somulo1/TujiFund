      ...
      <div className="relative z-10 flex-grow flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white tracking-tight">
            Welcome to{' '}
            <span className="text-indigo-400">TujiFund</span>
          </h1>
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            {isAuthenticated ? (
              <button
                ...
                className="px-8 py-3 text-lg font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
                Go to Dashboard
              </button>
            ) : (
              <>
                ...
                <button
                  ...
                  className="px-8 py-3 text-lg font-medium rounded-md text-white bg-transparent border-2 border-white hover:bg-white hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white"
                >
                  Register
                </button>
              </>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl w-full px-4">
          {[
            ...
            >
              <div className="flex items-center justify-center w-12 h-12 rounded-md bg-indigo-500 bg-opacity-10">
                {feature.icon}
              </div>
